...
export default function Page(): JSX.Element {
  ...
  async function viewFixture(): Promise<void> {
    setError(null)
    setSections(null)
    setStatus('unknown')
    setElapsed(0)
    ...
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="mx-auto max-w-3xl">
        <header className="mb-8">
          <h1 className="text-3xl font-semibold tracking-tight">PreCall</h1>
          <p className="mt-2 text-sm text-gray-500">
            Kick off a briefing for Sarah Chen (Ramp) and watch it run.
          </p>
        </header>
