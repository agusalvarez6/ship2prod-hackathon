      ...
      <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 text-sm text-slate-700 sm:grid-cols-3">
          ...
          <div>
            ...
            <dd className="mt-1">
              {user.google_access_token ? "Connected" : "Not connected"}
            </dd>
          </div>
          <div>
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">
              PreCall reads pages and calendar databases you share with it. You pick exactly
              which pages on Notion&rsquo;s consent screen.
            </p>
          </div>
          {notionConnected ? (
