...
const notionPageIdSchema = z
  ...
  .min(1)
  .refine(
    (s) => uuid.safeParse(s).success || uuid.safeParse(s.replace(/-/g, "").replace(/(.{8})(.{4})(.{4})(.{4})(.{12})/, "$1-$2-$3-$4-$5")).success,
...
export const UserId = {
  ...
  safeParse: (s: string) => {
    ...
    return r.success ? { success: true as const, data: r.data as UserId } : { success: false as const, error: r.error };
  },
...
export const MeetingId = {
  ...
  safeParse: (s: string) => {
    const r = uuid.safeParse(s);
    return r.success ? { success: true as const, data: r.data as MeetingId } : { success: false as const, error: r.error };
  },
...
export const BriefingId = {
  ...
  safeParse: (s: string) => {
    const r = uuid.safeParse(s);
    return r.success ? { success: true as const, data: r.data as BriefingId } : { success: false as const, error: r.error };
  },
...
export const JobId = {
  ...
  safeParse: (s: string) => {
    const r = uuid.safeParse(s);
    return r.success ? { success: true as const, data: r.data as JobId } : { success: false as const, error: r.error };
  },
...
export const SourceId = {
  ...
  safeParse: (s: string) => {
    const r = uuid.safeParse(s);
    return r.success ? { success: true as const, data: r.data as SourceId } : { success: false as const, error: r.error };
  },
...
export const TranscriptId = {
  ...
  safeParse: (s: string) => {
    const r = uuid.safeParse(s);
    return r.success ? { success: true as const, data: r.data as TranscriptId } : { success: false as const, error: r.error };
  },
...
export const NotionPageId = {
  ...
  safeParse: (s: string) => {
    ...
    return r.success ? { success: true as const, data: r.data as NotionPageId } : { success: false as const, error: r.error };
  },
};
