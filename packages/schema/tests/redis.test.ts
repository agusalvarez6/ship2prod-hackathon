...
describe("REDIS_KEYS", () => {
  ...
  it("builds progress + claim keys from a briefingId", () => {
    ...
    expect(REDIS_KEYS.progress(id)).toBe(
      "job:11111111-2222-3333-4444-555555555555:progress",
    );
    expect(REDIS_KEYS.claim(id)).toBe(
      "job:11111111-2222-3333-4444-555555555555:claim",
    );
  });
  ...
  it("builds cache keys", () => {
    ...
    expect(REDIS_KEYS.cache.briefing(b)).toBe(
      "cache:briefing:11111111-2222-3333-4444-555555555555",
    );
    ...
    expect(REDIS_KEYS.cache.notionSearch("abc123")).toBe(
      "cache:notion:search:abc123",
    );
  });
});
